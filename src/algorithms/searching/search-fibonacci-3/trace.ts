...
import { fibonacciSearch3, type Fib3Hooks } from './impl.ts';

export const DEFAULT_INPUT = [10, 22, 35, 40, 54, 62, 78, 81, 92, 99];
export const DEFAULT_TARGET = 78;
...
export function buildTrace(
  ...
  const result = fibonacciSearch3(input, target, hooks);
  const roles: BarRole[] = new Array(n).fill('default');
