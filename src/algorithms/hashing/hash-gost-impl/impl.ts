// hash-gost-impl 简化 · 实现（4 个 64 位字输出，单块链式）
const MASK64 = (1n << 64n) - 1n;
const IV: bigint[] = [0x01020304n, 0x05060708n, 0x090a0b0cn, 0x0d0e0f10n];
const MIX = 0x6c62272e07bb0142n;
const SHIFT = 5n;
...
export interface GostImplHooks {
  onBlock?: (i: number) => void;
  onResult?: (hash: bigint[]) => void;
}
export function hashGostImpl(
