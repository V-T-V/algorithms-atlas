...
export interface Md4ImplHooks {
  onBlock?: (i: number) => void;
  onResult?: (hash: bigint[]) => void;
}
export function hashMd4Impl(data: string | readonly number[], hooks: Md4ImplHooks = {}): bigint[] {
