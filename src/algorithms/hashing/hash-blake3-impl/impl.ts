// hash-blake3-impl 简化 · 实现（4 个 64 位字输出，单块链式）
...
export interface Blake3ImplHooks {
  onBlock?: (i: number) => void;
  onResult?: (hash: bigint[]) => void;
}
export function hashBlake3Impl(
  data: string | readonly number[],
  hooks: Blake3ImplHooks = {},
): bigint[] {
