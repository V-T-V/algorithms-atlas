// hash-md2-impl 简化 · 实现（4 个 64 位字输出，单块链式）
const MASK64 = (1n << 64n) - 1n;
const IV: bigint[] = [0x01n, 0x23n, 0x45n, 0x67n];
const MIX = 0xc6a4a793n;
const SHIFT = 7n;
...
export interface Md2ImplHooks {
  onBlock?: (i: number) => void;
  onResult?: (hash: bigint[]) => void;
}
export function hashMd2Impl(data: string | readonly number[], hooks: Md2ImplHooks = {}): bigint[] {
