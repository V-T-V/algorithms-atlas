...
export interface Ripemd160ImplHooks {
  onBlock?: (i: number) => void;
  onResult?: (hash: bigint[]) => void;
}
export function hashRipemd160Impl(
  data: string | readonly number[],
  hooks: Ripemd160ImplHooks = {},
): bigint[] {
